...
export type CardSpecial = 'probe' | 'coldRead' | 'finePrint' | 'honeyed' | 'crocodile' | 'advocate';
...
export const CARDS: Record<CardId, CardDef> = {
  ...
  'crocodile-tears': {
    ...
    dmg: 0, susp: 0, soothe: 18, special: 'crocodile', price: 3,
  ...
  'devils-advocate': {
    ...
    dmg: 0, susp: 5, special: 'advocate', price: 4,
    desc: 'Damage equals a quarter of their suspicion.',
  },
  'cold-read': {
...
/** Deck every fresh demon is issued. */
...
/** Cards the Commissary may stock. */
